...
class lab9(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab9")
        ...
        self.amp = amp = 0
        self.alpha = alpha = 1
        self.adapt = adapt = digital.adaptive_algorithm_cma( con, .0001, 1).base()
        ...
        self.digital_linear_equalizer_0 = digital.linear_equalizer(4, 1, adapt, True, [ ], 'corr_est')
        ...
        self.blocks_skiphead_1_0 = blocks.skiphead(gr.sizeof_char*1, 0)
        self.blocks_skiphead_1 = blocks.skiphead(gr.sizeof_gr_complex*1, 2)
        self.blocks_pack_k_bits_bb_1 = blocks.pack_k_bits_bb(3)
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, '/home/joel/Documents/EE340/lab9.txt', False)
        ...
        self.connect((self.blocks_skiphead_1_0, 0), (self.blocks_unpack_k_bits_bb_1, 0))
        ...
        self.connect((self.digital_constellation_decoder_cb_0, 0), (self.blocks_skiphead_1_0, 0))
...
def main(top_block_cls=lab9, options=None):
