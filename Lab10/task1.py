...
class task1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._skip_range = Range(0, 7, 0.01, 0, 200)
        self._skip_win = RangeWidget(self._skip_range, self.set_skip, "'skip'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._skip_win)
        self.root_raised_cosine_filter_0_0_2 = filter.fir_filter_fff(
            1,
            firdes.root_raised_cosine(
                ...
                alpha,
                11*8))
        self.root_raised_cosine_filter_0_0_1 = filter.fir_filter_fff(
            1,
            firdes.root_raised_cosine(
                1,
                8*50e3,
        ...
        self.blocks_skiphead_0 = blocks.skiphead(gr.sizeof_char*1, 1027)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/joel/Documents/EE340/Lab10/out.txt', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_complex_to_float_1 = blocks.complex_to_float(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_2 = analog.sig_source_f(8e6, analog.GR_COS_WAVE, 500e3, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(8e6, analog.GR_SIN_WAVE, 500e3, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(8e6, analog.GR_SIN_WAVE, 500e3, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(8e6, analog.GR_COS_WAVE, 500e3, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_2, 0), (self.blocks_multiply_xx_1_0, 0))
        ...
        self.connect((self.blocks_complex_to_float_1, 0), (self.interp_fir_filter_xxx_0, 0))
        self.connect((self.blocks_complex_to_float_1, 1), (self.interp_fir_filter_xxx_0_0, 0))
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0, 0), (self.blocks_complex_to_float_1, 0))
        ...
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.root_raised_cosine_filter_0_0_1, 0))
        self.connect((self.interp_fir_filter_xxx_0_0, 0), (self.root_raised_cosine_filter_0_0_2, 0))
        self.connect((self.low_pass_filter_0_0, 0), (self.rational_resampler_xxx_1_0, 0))
        self.connect((self.low_pass_filter_0_0_0, 0), (self.rational_resampler_xxx_1, 0))
        ...
        self.connect((self.rational_resampler_xxx_1_0_0, 0), (self.blocks_multiply_xx_0_0, 1))
        self.connect((self.rational_resampler_xxx_1_1, 0), (self.blocks_multiply_xx_0, 0))
        ...
        self.connect((self.root_raised_cosine_filter_0_0_1, 0), (self.rational_resampler_xxx_1_1, 0))
        self.connect((self.root_raised_cosine_filter_0_0_2, 0), (self.rational_resampler_xxx_1_0_0, 0))
    ...
    def set_alpha(self, alpha):
        self.alpha = alpha
        self.root_raised_cosine_filter_0_0.set_taps(firdes.root_raised_cosine(1, 8*50e3, 50e3, self.alpha, 11*8))
        self.root_raised_cosine_filter_0_0_0.set_taps(firdes.root_raised_cosine(1, 8*50e3, 50e3, self.alpha, 11*8))
        self.root_raised_cosine_filter_0_0_1.set_taps(firdes.root_raised_cosine(1, 8*50e3, 50e3, self.alpha, 11*8))
        self.root_raised_cosine_filter_0_0_2.set_taps(firdes.root_raised_cosine(1, 8*50e3, 50e3, self.alpha, 11*8))
