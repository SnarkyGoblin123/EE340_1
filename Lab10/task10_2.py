...
class task10_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "task10_2")
        ...
        self.con = con = digital.constellation_calcdist([-1 -1j, -1 + 1j, 1 + 1j, 1 - 1j], [0, 1, 2, 3],
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/joel/Documents/EE340/Lab10/out6.txt', False)
        ...
        self.connect((self.blocks_phase_shift_0, 0), (self.blocks_multiply_xx_0, 1))
...
def main(top_block_cls=task10_2, options=None):
