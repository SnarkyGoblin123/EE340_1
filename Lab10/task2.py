...
class task2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.con = con = digital.constellation_calcdist([-1-1j, -1+1j, 1+1j, 1-1j], [0, 1, 3, 2],
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, '/home/joel/Documents/EE340/Lab10/out9.txt', False)
        ...
        self.connect((self.blocks_multiply_xx_3, 0), (self.digital_constellation_decoder_cb_0_0, 0))
