...
class task5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.freq_off = freq_off = 100
        self.con = con = digital.constellation_calcdist([-0.707 -0.707j, -1, -0.707 + 0.707j, 1j, 0.707 + 0.707j, 1, 0.707 - 0.707j, -1j], [0, 1,2,3,4,5,6,7],
        ...
        # Blocks
        ##################################################
        self._freq_off_range = Range(0, 100, 0.1, 100, 200)
        ...
        self.zeromq_push_sink_0_0 = zeromq.push_sink(gr.sizeof_float, 1, 'tcp://127.0.0.1:50001', 100, False, -1)
        self.zeromq_pull_source_0_0 = zeromq.pull_source(gr.sizeof_float, 1, 'tcp://127.0.0.1:50001', 100, False, -1)
        ...
        self.digital_constellation_decoder_cb_0_0 = digital.constellation_decoder_cb(con)
        self.digital_constellation_decoder_cb_0 = digital.constellation_decoder_cb(con)
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bc([-0.707 -0.707j, -1, -0.707 + 0.707j, 1j, 0.707 + 0.707j, 1, 0.707 - 0.707j, -1j], 1)
        self.blocks_vco_c_0_0 = blocks.vco_c(50e3, -5.3, 1)
        self.blocks_vco_c_0 = blocks.vco_c(50e3, 50e3, 1)
        self.blocks_unpack_k_bits_bb_1_0 = blocks.unpack_k_bits_bb(3)
        self.blocks_unpack_k_bits_bb_1 = blocks.unpack_k_bits_bb(3)
        self.blocks_unpack_k_bits_bb_0 = blocks.unpack_k_bits_bb(8)
        self.blocks_skiphead_0_0 = blocks.skiphead(gr.sizeof_char*1, 43)
        self.blocks_skiphead_0 = blocks.skiphead(gr.sizeof_char*1, 43)
        ...
        self.blocks_multiply_xx_2_4 = blocks.multiply_vcc(1)
        self.blocks_multiply_xx_2_3 = blocks.multiply_vcc(1)
        self.blocks_multiply_xx_2_1_0 = blocks.multiply_vcc(1)
        self.blocks_multiply_xx_2_1 = blocks.multiply_vcc(1)
        self.blocks_multiply_xx_2_0_1 = blocks.multiply_vcc(1)
        ...
        self.blocks_multiply_const_vxx_1_1 = blocks.multiply_const_ff(1/8)
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, '/home/joel/Documents/EE340/Lab10/out7.txt', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/joel/Documents/EE340/Lab10/out4.txt', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_delay_0_0 = blocks.delay(gr.sizeof_float*1, 150)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_gr_complex*1, 1)
        self.blocks_complex_to_real_0 = blocks.complex_to_real(1)
        self.blocks_complex_to_arg_0_0 = blocks.complex_to_arg(1)
        self.blocks_complex_to_arg_0 = blocks.complex_to_arg(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_1_0_0 = analog.sig_source_f(8e6, analog.GR_SIN_WAVE, 500e3 + freq_off, 1, 0, 0.0)
        self.analog_sig_source_x_1_0 = analog.sig_source_f(8e6, analog.GR_COS_WAVE, 500e3 + freq_off, 1, 0, 0.0)
        ...
        self.connect((self.blocks_complex_to_arg_0_0, 0), (self.iir_filter_xxx_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_1_1, 0), (self.zeromq_push_sink_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_1_1_0, 0), (self.blocks_vco_c_0_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_2, 0), (self.blocks_multiply_xx_2_1, 0))
        self.connect((self.blocks_multiply_xx_2, 0), (self.blocks_multiply_xx_2_1, 1))
        self.connect((self.blocks_multiply_xx_2_0, 0), (self.blocks_delay_0, 0))
        self.connect((self.blocks_multiply_xx_2_0, 0), (self.blocks_multiply_conjugate_cc_0, 1))
        self.connect((self.blocks_multiply_xx_2_0_1, 0), (self.blocks_complex_to_arg_0_0, 0))
        self.connect((self.blocks_multiply_xx_2_1, 0), (self.blocks_multiply_xx_2_0, 1))
        self.connect((self.blocks_multiply_xx_2_1, 0), (self.blocks_multiply_xx_2_0, 0))
        self.connect((self.blocks_multiply_xx_2_1_0, 0), (self.blocks_multiply_xx_2_0_1, 0))
        self.connect((self.blocks_multiply_xx_2_1_0, 0), (self.blocks_multiply_xx_2_0_1, 1))
        self.connect((self.blocks_multiply_xx_2_3, 0), (self.blocks_multiply_xx_3_0, 0))
        self.connect((self.blocks_multiply_xx_2_3, 0), (self.digital_constellation_decoder_cb_0_0, 0))
        self.connect((self.blocks_multiply_xx_2_3, 0), (self.qtgui_const_sink_x_1_0, 0))
        self.connect((self.blocks_multiply_xx_2_4, 0), (self.blocks_multiply_xx_2_1_0, 1))
        self.connect((self.blocks_multiply_xx_2_4, 0), (self.blocks_multiply_xx_2_1_0, 0))
        self.connect((self.blocks_multiply_xx_3_0, 0), (self.blocks_multiply_xx_2_4, 1))
        self.connect((self.blocks_multiply_xx_3_0, 0), (self.blocks_multiply_xx_2_4, 0))
        self.connect((self.blocks_multiply_xx_3_0, 0), (self.digital_constellation_decoder_cb_0, 0))
        self.connect((self.blocks_multiply_xx_3_0, 0), (self.qtgui_const_sink_x_1, 0))
        ...
        self.connect((self.blocks_vco_c_0, 0), (self.blocks_multiply_xx_2_3, 1))
        self.connect((self.blocks_vco_c_0_0, 0), (self.blocks_multiply_xx_3_0, 1))
        ...
        self.connect((self.fir_filter_xxx_0, 0), (self.blocks_multiply_xx_2, 0))
        self.connect((self.fir_filter_xxx_0, 0), (self.blocks_multiply_xx_2, 1))
        self.connect((self.fir_filter_xxx_0, 0), (self.blocks_multiply_xx_2_3, 0))
        ...
        self.connect((self.zeromq_pull_source_0_0, 0), (self.blocks_delay_0_0, 0))
