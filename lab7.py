...
class lab7(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab7")
        ...
        self._skip_range = Range(0, 100, 1, 50, 200)
        ...
        self.blocks_skiphead_1 = blocks.skiphead(gr.sizeof_float*1, 66)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/joel/Documents/EE340/lab7.txt', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(400e3, analog.GR_COS_WAVE, 100e3, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(400e3, analog.GR_COS_WAVE, 100e3, 1, 0, 0)
...
def main(top_block_cls=lab7, options=None):
